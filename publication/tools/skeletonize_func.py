...
def get_skeleton(mask_image,pixcdate,figdir,dilate_amount,gauss_amount,season='LF',second_dilation=True,savePlot=False):
    ...
    if savePlot == True:
        ...
        ax[0].axis('off')
        ax[0].set_title('Water mask', fontsize=18)

        ax[1].imshow(dilated_mask, cmap=plt.cm.gray)
        ax[1].axis('off')
        ax[1].set_title('Dilation', fontsize=18)

        #ax[2].imshow(largest_component_mask, cmap=plt.cm.gray)
        #ax[2].axis('off')
        #ax[2].set_title('Largest connection', fontsize=18)

        ax[2].imshow(smoothed_mask, cmap=plt.cm.gray)
        ax[2].axis('off')
        ax[2].set_title('Gaussian filter', fontsize=18)

        if second_dilation == True:
            ax[3].imshow(largest_component_mask_smoothed, cmap=plt.cm.gray)
            ax[3].axis('off')
            ax[3].set_title('Secondary dilation', fontsize=18)
            ...
            ax[4].axis('off')
            ax[4].set_title('Skeleton', fontsize=18)
            ...
            ax[3].axis('off')
            ax[3].set_title('Skeleton', fontsize=18)
...
def get_pruned_skeleton(skeleton,mask_image,pixcdate,figdir,distance_threshold=30,max_hole_size=300,prunethresh=600):
    ...
    # ax[0].axis('off')
    # ax[0].set_title('Skeleton', fontsize=18)
    ...
    ax[0].axis('off')
    ax[0].set_title('Connect ends', fontsize=18)
    ...
    ax[1].axis('off')
    ax[1].set_title('Fill holes', fontsize=18)
    ...
    # ax[3].axis('off')
    # ax[3].set_title('E&J', fontsize=18)
    ...
    ax[2].axis('off')
    ax[2].set_title('Prune branches', fontsize=18)
    ...
    ax[3].scatter(x, y, color='blue', s=0.5) 
    ax[3].axis('off')
    ax[3].set_title('Final skeleton', fontsize=18)
