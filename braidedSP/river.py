...
class River:
    ...
    def process_swot(self, dilate=5, include_dark_water=False, engine='netcdf'):
        ...
        for i in range(len(self.swot_obs)):
            ...
            self.swot_obs[i].load_pixc(extraction_mask, mask_transform, mask_crs, include_dark_water=include_dark_water, engine=engine)
